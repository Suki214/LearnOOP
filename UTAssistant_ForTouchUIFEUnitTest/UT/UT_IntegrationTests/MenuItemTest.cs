...
namespace UT_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(VSPackage.UTAssistant.GuidList.guidUTCmdSet, (int)VSPackage.UTAssistant.PkgCmdIDList.cmdidOpenTests);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "UT", "VSPackage.UT.UTPackage");
