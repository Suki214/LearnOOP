...
using VSPackage.UTAssistant;

namespace UT_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new UTAssistantPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(VSPackage.UTAssistant.GuidList.guidUTCmdSet, (int)VSPackage.UTAssistant.PkgCmdIDList.cmdidOpenTests);
