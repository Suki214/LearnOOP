namespace PrismTwitterReader.TwitterAccesss
{
    public class TwitterConstants
    {
        ...
        public const string StreamUrl = "https://userstream.twitter.com/1.1/user.json?stall_warnings=true&replies=all&with=followings";
        public const int MaxTweetsToRetrieve = 150; // Could be 250, but 150 for better performance
